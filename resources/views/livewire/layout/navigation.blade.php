    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('categorias.index')" :active="request()->routeIs('categorias.*')" wire:navigate>
                        {{ __('Categorias') }}
                    </x-nav-link>                               
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('vendedores.index')" :active="request()->routeIs('vendedores.*')" wire:navigate>
                        {{ __('Vendedores') }}
                    </x-nav-link>                               
                </div>
