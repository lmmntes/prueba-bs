    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="px-6 py-4">
                    <button onclick="get_producto( {{ $item->id }} )" data-modal-target="updateProductModal" data-modal-toggle="updateProductModal" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                    ...
                    <button  wire:confirm='Seguro que quieres borrar este producto?' wire:click="delete({{ $item }})" class="font-medium text-red-800 dark:text-red-500 hover:underline">
